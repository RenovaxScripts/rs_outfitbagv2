...
AddEventHandler('rs_outfitbag:placedBag', function()
    ...
    if Config.Inventory == 'nord' or Config.Inventory == 'nord_inventory' then
        exports.nord_inventory:RemoveItem(src, Config.Item.item, 1)
...
AddEventHandler('rs_outfitbag:pickedupBag', function()
    ...
    if Config.Inventory == 'nord' or Config.Inventory == 'nord_inventory' then
        exports.nord_inventory:AddItem(src, Config.Item.item, 1)
    elseif Config.Inventory == 'ox' then
